...
`;function ew({className:s,style:e,rotation:i=45,speed:r=.2,colors:l=[],transparent:c=!0,autoRotate:f=0,scale:d=1,frequency:m=1,warpStrength:p=1,mouseInfluence:g=1,parallax:_=.5,noise:v=.1}){const S=F.useRef(null),y=F.useRef(null),T=F.useRef(null),M=F.useRef(null),x=F.useRef(null),O=F.useRef(i),C=F.useRef(f),P=F.useRef(new Rt(0,0)),L=F.useRef(new Rt(0,0)),z=F.useRef(8);return F.useEffect(()=>{const N=S.current,Z=new Wb,A=new Np(-1,1,1,-1,0,1),D=new hl(2,2),H=Array.from({length:$c},()=>new fe(0,0,0)),j=new Di({vertexShader:$C,fragmentShader:JC,uniforms:{uCanvas:{value:new Rt(1,1)},uTime:{value:0},uSpeed:{value:r},uRot:{value:new Rt(1,0)},uColorCount:{value:0},uColors:{value:H},uTransparent:{value:c?1:0},uScale:{value:d},uFrequency:{value:m},uWarpStrength:{value:p},uPointer:{value:new Rt(0,0)},uMouseInfluence:{value:g},uParallax:{value:_},uNoise:{value:v}},premultipliedAlpha:!0,transparent:!0});M.current=j;const q=new Yi(D,j);Z.add(q);const ae=new QC({antialias:!1,powerPreference:"high-performance",alpha:!0});y.current=ae,ae.outputColorSpace=ai,ae.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),ae.setClearColor(0,c?0:1),ae.domElement.style.width="100%",ae.domElement.style.height="100%",ae.domElement.style.display="block",N.appendChild(ae.domElement);const ee=new t1,B=()=>{const k=N.clientWidth||1,de=N.clientHeight||1;ae.setSize(k,de,!1),j.uniforms.uCanvas.value.set(k,de)};if(B(),"ResizeObserver"in window){const k=new ResizeObserver(B);k.observe(N),x.current=k}else window.addEventListener("resize",B);const V=()=>{const k=ee.getDelta(),de=ee.elapsedTime;j.uniforms.uTime.value=de;const Y=(O.current%360+C.current*de)*Math.PI/180,re=Math.cos(Y),pe=Math.sin(Y);j.uniforms.uRot.value.set(re,pe);const Re=L.current,He=P.current,te=Math.min(1,k*z.current);Re.lerp(He,te),j.uniforms.uPointer.value.copy(Re),ae.render(Z,A),T.current=requestAnimationFrame(V)};return T.current=requestAnimationFrame(V),()=>{T.current!==null&&cancelAnimationFrame(T.current),x.current?x.current.disconnect():window.removeEventListener("resize",B),D.dispose(),j.dispose(),ae.dispose(),ae.domElement&&ae.domElement.parentElement===N&&N.removeChild(ae.domElement)}},[m,g,v,_,d,r,c,p]),F.useEffect(()=>{const N=M.current,Z=y.current;if(!N)return;O.current=i,C.current=f,N.uniforms.uSpeed.value=r,N.uniforms.uScale.value=d,N.uniforms.uFrequency.value=m,N.uniforms.uWarpStrength.value=p,N.uniforms.uMouseInfluence.value=g,N.uniforms.uParallax.value=_,N.uniforms.uNoise.value=v;const A=H=>{const j=H.replace("#","").trim(),q=j.length===3?[parseInt(j[0]+j[0],16),parseInt(j[1]+j[1],16),parseInt(j[2]+j[2],16)]:[parseInt(j.slice(0,2),16),parseInt(j.slice(2,4),16),parseInt(j.slice(4,6),16)];return new fe(q[0]/255,q[1]/255,q[2]/255)},D=(l||[]).filter(Boolean).slice(0,$c).map(A);for(let H=0;H<$c;H++){const j=N.uniforms.uColors.value[H];H<D.length?j.copy(D[H]):j.set(0,0,0)}N.uniforms.uColorCount.value=D.length,N.uniforms.uTransparent.value=c?1:0,Z&&Z.setClearColor(0,c?0:1)},[i,f,r,d,m,p,g,_,v,l,c]),F.useEffect(()=>{const N=M.current,Z=S.current;if(!N||!Z)return;const A=D=>{const H=Z.getBoundingClientRect(),j=(D.clientX-H.left)/(H.width||1)*2-1,q=-((D.clientY-H.top)/(H.height||1)*2-1);P.current.set(j,q)};return Z.addEventListener("pointermove",A),()=>{Z.removeEventListener("pointermove",A)}},[]),Zt.jsx("div",{ref:S,className:`color-bends-container ${s}`,style:e})}const tw={auto:!1,ref:null},Hx=s=>({...tw,...s}),Vx=F.createContext(null),nw=Zi("useFullscreen","FullscreenContext",Vx);function iw({fullscreen:s,on:e,children:i}){const{auto:r,ref:l}=Hx(s),c=F.useRef(null),[f,d]=F.useState(),[m,p]=F.useState(!1),g=F.useRef(!1),{getOwnerDocument:_}=ol();wi(()=>{var C,P,L,z;const N=_();d(!((z=(L=(P=(C=N.fullscreenEnabled)!==null&&C!==void 0?C:N.webkitFullscreenEnabled)!==null&&P!==void 0?P:N.mozFullScreenEnabled)!==null&&L!==void 0?L:N.msFullscreenEnabled)!==null&&z!==void 0&&z))},[_]);const v=F.useCallback(()=>{var C;const P=_(),L=P.fullscreenElement||P.webkitFullscreenElement||P.mozFullScreenElement||P.msFullscreenElement;return((C=L==null?void 0:L.shadowRoot)===null||C===void 0?void 0:C.fullscreenElement)||L},[_]),S=F.useCallback(()=>{const C=c.current;try{C.requestFullscreen?C.requestFullscreen().catch(()=>{}):C.webkitRequestFullscreen?C.webkitRequestFullscreen():C.mozRequestFullScreen?C.mozRequestFullScreen():C.msRequestFullscreen&&C.msRequestFullscreen()}catch{}},[]),y=F.useCallback(()=>{if(!v())return;const C=_();try{C.exitFullscreen?C.exitFullscreen().catch(()=>{}):C.webkitExitFullscreen?C.webkitExitFullscreen():C.mozCancelFullScreen?C.mozCancelFullScreen():C.msExitFullscreen&&C.msExitFullscreen()}catch{}},[v,_]);F.useEffect(()=>{const C=_(),P=()=>{p(v()===c.current)};return su(...["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].map(L=>(C.addEventListener(L,P),()=>C.removeEventListener(L,P))))},[v,_]);const T=Lt(()=>{var C;return(C=e.enterFullscreen)===null||C===void 0?void 0:C.call(e)}),M=Lt(()=>{var C;return(C=e.exitFullscreen)===null||C===void 0?void 0:C.call(e)});F.useEffect(()=>{m&&(g.current=!0),g.current&&(m?T:M)()},[m,T,M]);const x=Lt(()=>{var C;return(C=r?S:null)===null||C===void 0||C(),y});F.useEffect(x,[x]);const O=F.useMemo(()=>({fullscreen:m,disabled:f,enter:S,exit:y}),[m,f,S,y]);return F.useImperativeHandle(l,()=>O,[O]),F.createElement("div",{ref:c,className:Ci(xt(oh),xt(Nv))},F.createElement(Vx.Provider,{value:O},i))}const aw=ji("EnterFullscreen",F.createElement("path",{d:"M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z"})),rw=ji("ExitFullscreen",F.createElement("path",{d:"M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z"}));function sw(){var s;const{fullscreen:e,disabled:i,enter:r,exit:l}=nw(),{render:c}=Zn();return i?null:c.buttonFullscreen?F.createElement(F.Fragment,null,(s=c.buttonFullscreen)===null||s===void 0?void 0:s.call(c,{fullscreen:e,disabled:i,enter:r,exit:l})):F.createElement(ll,{disabled:i,label:e?"Exit Fullscreen":"Enter Fullscreen",icon:e?rw:aw,renderIcon:e?c.iconExitFullscreen:c.iconEnterFullscreen,onClick:e?l:r})}function ow({augment:s,contains:e,addParent:i}){s(({fullscreen:r,toolbar:l,...c})=>({toolbar:xp(l,oh,F.createElement(sw,null)),fullscreen:Hx(r),...c})),i(e(m_)?m_:lp,Ra(oh,iw))}const lw={share:void 0},Gx=s=>({...lw,...s});function cw(){return typeof navigator<"u"&&!!navigator.canShare}const uw=ji("ShareIcon",F.createElement("path",{d:"m16 5-1.42 1.42-1.59-1.59V16h-1.98V4.83L9.42 6.42 8 5l4-4 4 4zm4 5v11c0 1.1-.9 2-2 2H6c-1.11 0-2-.9-2-2V10c0-1.11.89-2 2-2h3v2H6v11h12V10h-3V8h3c1.1 0 2 .89 2 2z"}));function fw(){const{render:s,on:e,share:i}=Zn(),{share:r}=Gx(i),{currentSlide:l,currentIndex:c}=Ca();if(!cw())return null;if(s.buttonShare)return F.createElement(F.Fragment,null,s.buttonShare());const f=l&&(typeof l.share=="object"&&l.share||typeof l.share=="string"&&{url:l.share}||Xr(l)&&{url:l.src})||void 0,d=r?(l==null?void 0:l.share)!==!1:f&&navigator.canShare(f),m=()=>{f&&navigator.share(f).catch(()=>{})},p=()=>{var g;l&&((r||m)({slide:l}),(g=e.share)===null||g===void 0||g.call(e,{index:c}))};return F.createElement(ll,{label:"Share",icon:uw,renderIcon:s.iconShare,disabled:!d,onClick:p})}function dw({augment:s}){s(({toolbar:e,share:i,...r})=>({toolbar:xp(e,"share",F.createElement(fw,null)),share:Gx(i),...r}))}const hw={minZoom:1,maxZoomPixelRatio:1,zoomInMultiplier:2,doubleTapDelay:300,doubleClickDelay:500,doubleClickMaxStops:2,keyboardMoveDistance:50,wheelZoomDistanceFactor:100,pinchZoomDistanceFactor:100,pinchZoomV4:!1,scrollToZoom:!1};function pw(s){return Math.min(Math.max(s,Number.EPSILON),1)}function kx(s){const{minZoom:e,...i}={...hw,...s};return{minZoom:pw(e),...i}}function mw(s,e,i,r){const l=F.useRef(void 0),c=F.useRef(void 0),{zoom:f}=Zn().animation,d=Sp(),m=Lt(()=>{var p,g,_;if((p=l.current)===null||p===void 0||p.cancel(),l.current=void 0,c.current&&(r!=null&&r.current)){try{l.current=(_=(g=r.current).animate)===null||_===void 0?void 0:_.call(g,[{transform:c.current},{transform:`scale(${s}) translateX(${e}px) translateY(${i}px)`}],{duration:d?0:f??500,easing:l.current?"ease-out":"ease-in-out"})}catch(v){console.error(v)}c.current=void 0,l.current&&(l.current.onfinish=()=>{l.current=void 0})}});return wi(m,[s,e,i,m]),F.useCallback(()=>{c.current=r!=null&&r.current?window.getComputedStyle(r.current).transform:void 0},[r])}function gw(s,e){const{on:i}=Zn(),r=Lt(()=>{var l;e||(l=i.zoom)===null||l===void 0||l.call(i,{zoom:s})});F.useEffect(r,[s,r])}function pu(){const{zoom:s}=Zn();return kx(s)}function _w(s,e){var i,r;let l={width:0,height:0},c={width:0,height:0};const{currentSlide:f}=Ca(),{imageFit:d}=Zn().carousel,{maxZoomPixelRatio:m}=pu();if(s&&f){const g={...f,...e};if(Xr(g)){const _=_p(g,d),v=Math.max(...(((i=g.srcSet)===null||i===void 0?void 0:i.map(y=>y.width))||[]).concat(g.width?[g.width]:[])),S=Math.max(...(((r=g.srcSet)===null||r===void 0?void 0:r.map(y=>y.height))||[]).concat(g.height?[g.height]:[]));v>0&&S>0&&s.width>0&&s.height>0&&(c=_?{width:Math.round(Math.min(v,s.width/s.height*S)),height:Math.round(Math.min(S,s.height/s.width*v))}:{width:v,height:S},c={width:c.width*m,height:c.height*m},l=_?{width:Math.min(s.width,c.width,v),height:Math.min(s.height,c.height,S)}:{width:Math.round(Math.min(s.width,s.height/S*v,v)),height:Math.round(Math.min(s.height,s.width/v*S,S))})}}const p=l.width?Math.max(gp(c.width/l.width,5),1):1;return{imageRect:l,maxZoom:p}}function bv(s,e){return Math.hypot(s.clientX-e.clientX,s.clientY-e.clientY)}function Tv(s,e,i=100,r=2){return s*Math.min(1+Math.abs(e/i),r)**Math.sign(e)}function vw(s,e,i,r,l,c,f,d,m){const p=F.useRef([]),g=F.useRef(0),_=F.useRef(void 0),{globalIndex:v}=Ca(),{getOwnerWindow:S}=ol(),{containerRef:y,subscribeSensors:T}=wa(),{keyboardMoveDistance:M,zoomInMultiplier:x,wheelZoomDistanceFactor:O,scrollToZoom:C,doubleTapDelay:P,doubleClickDelay:L,doubleClickMaxStops:z,pinchZoomDistanceFactor:N,pinchZoomV4:Z}=pu(),A=F.useCallback(k=>{if(y.current){const{pageX:de,pageY:U}=k,{scrollX:Y,scrollY:re}=S(),{left:pe,top:Re,width:He,height:te}=y.current.getBoundingClientRect();return[de-pe-Y-He/2,U-Re-re-te/2]}return[]},[y,S]),D=Lt(k=>{const{key:de,metaKey:U,ctrlKey:Y}=k,re=U||Y,pe=()=>{k.preventDefault(),k.stopPropagation()};if(s>1){const Re=(He,te)=>{pe(),d(He,te)};de==="ArrowDown"?Re(0,M):de==="ArrowUp"?Re(0,-M):de==="ArrowLeft"?Re(-M,0):de==="ArrowRight"&&Re(M,0)}de==="+"||re&&de==="="?(pe(),l()):de==="-"||re&&de==="_"?(pe(),c()):re&&de==="0"&&(pe(),f(1))}),H=Lt(k=>{if((k.ctrlKey||C)&&Math.abs(k.deltaY)>Math.abs(k.deltaX)){k.stopPropagation(),f(Tv(s,-k.deltaY,O),!0,...A(k));return}s>1&&(k.stopPropagation(),C||d(k.deltaX,k.deltaY))}),j=F.useCallback(k=>{const de=p.current;de.splice(0,de.length,...de.filter(U=>U.pointerId!==k.pointerId))},[]),q=F.useCallback(k=>{j(k),k.persist(),p.current.push(k)},[j]),ae=Lt(k=>{var de;const U=p.current;if(k.pointerType==="mouse"&&k.buttons>1||!(!((de=m==null?void 0:m.current)===null||de===void 0)&&de.contains(k.target)))return;s>1&&k.stopPropagation();const{timeStamp:Y}=k;if(U.length===0&&Y-g.current<(k.pointerType==="touch"?P:L)){g.current=0;const re=s>=1?s!==i?s*Math.max(i**(1/z),x):1:s!==e?s/Math.max(e**(-1/z),x):1;f(re,!1,...A(k))}else g.current=Y;if(q(k),U.length===2){const re=bv(U[0],U[1]);_.current={previousDistance:re,initialDistance:Math.max(re,1),initialZoom:s}}}),ee=Lt(k=>{const de=p.current,U=de.find(Y=>Y.pointerId===k.pointerId);if(de.length===2&&_.current){k.stopPropagation(),q(k);const Y=bv(de[0],de[1]),re=Z?_.current.initialZoom/_.current.initialDistance*Y:Tv(s,Y-_.current.previousDistance,N);f(re,!0,...de.map(pe=>A(pe)).reduce((pe,Re)=>Re.map((He,te)=>pe[te]+He/2))),_.current.previousDistance=Y;return}s>1&&(k.stopPropagation(),U&&(de.length===1&&d((U.clientX-k.clientX)/s,(U.clientY-k.clientY)/s),q(k)))}),B=F.useCallback(k=>{const de=p.current;de.length===2&&de.find(U=>U.pointerId===k.pointerId)&&(_.current=void 0),j(k)},[j]),V=F.useCallback(()=>{const k=p.current;k.splice(0,k.length),g.current=0,_.current=void 0},[]);nx(T,ae,ee,B,r),F.useEffect(V,[v,V]),F.useEffect(()=>r?()=>{}:su(V,T(dp,D),T(hp,H)),[r,T,V,D,H])}function xw(s,e,i){const[r,l]=F.useState(1),[c,f]=F.useState(0),[d,m]=F.useState(0),p=mw(r,c,d,i),{currentSlide:g,globalIndex:_}=Ca(),{containerRect:v,slideRect:S}=wa(),{minZoom:y,zoomInMultiplier:T}=pu(),M=g&&Xr(g)?g.src:void 0,x=!M||!(i!=null&&i.current);wi(()=>{l(1),f(0),m(0)},[_,M]);const O=F.useCallback((N,Z,A)=>{const D=A||r,H=c-(N||0),j=d-(Z||0),q=(s.width*D-S.width)/2/D,ae=(s.height*D-S.height)/2/D;f(Math.min(Math.abs(H),Math.max(q,0))*Math.sign(H)),m(Math.min(Math.abs(j),Math.max(ae,0))*Math.sign(j))},[r,c,d,S,s.width,s.height]),C=F.useCallback((N,Z,A,D)=>{const H=gp(N+.01<e?N-.01>y?N:y:e,5);Z||p(),O(A?A*(1/r-1/H):0,D?D*(1/r-1/H):0,H),l(H)},[r,y,e,O,p]),P=Lt(()=>{r>1&&(r>e&&C(e,!0),O())});wi(P,[v.width,v.height,P]);const L=F.useCallback(()=>{const N=r*T;C(r<1&&N>1?1:N)},[r,T,C]),z=F.useCallback(()=>{const N=r/T;C(r>1&&N<1?1:N)},[r,T,C]);return{zoom:r,offsetX:c,offsetY:d,disabled:x,changeOffsets:O,changeZoom:C,zoomIn:L,zoomOut:z}}const Xx=F.createContext(null),Op=Zi("useZoom","ZoomControllerContext",Xx);function Sw({children:s}){const[e,i]=F.useState(),{slideRect:r}=wa(),{ref:l,minZoom:c}=pu(),{imageRect:f,maxZoom:d}=_w(r,e==null?void 0:e.imageDimensions),{zoom:m,offsetX:p,offsetY:g,disabled:_,changeZoom:v,changeOffsets:S,zoomIn:y,zoomOut:T}=xw(f,d,e==null?void 0:e.zoomWrapperRef);gw(m,_),vw(m,c,d,_,y,T,v,S,e==null?void 0:e.zoomWrapperRef);const M=F.useMemo(()=>({zoom:m,minZoom:c,maxZoom:d,offsetX:p,offsetY:g,disabled:_,zoomIn:y,zoomOut:T,changeZoom:v}),[m,c,d,p,g,_,y,T,v]);F.useImperativeHandle(l,()=>M,[M]);const x=F.useMemo(()=>({...M,setZoomWrapper:i}),[M,i]);return F.createElement(Xx.Provider,{value:x},s)}const Mw=ji("ZoomIn",F.createElement(F.Fragment,null,F.createElement("path",{d:"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"}),F.createElement("path",{d:"M12 10h-2v2H9v-2H7V9h2V7h1v2h2v1z"}))),Ew=ji("ZoomOut",F.createElement("path",{d:"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM7 9h5v1H7z"})),Av=F.forwardRef(function({zoomIn:e,onLoseFocus:i},r){const l=F.useRef(!1),c=F.useRef(!1),{zoom:f,minZoom:d,maxZoom:m,zoomIn:p,zoomOut:g,disabled:_}=Op(),{render:v}=Zn(),S=_||(e?f>=m:f<=d);return F.useEffect(()=>{S&&l.current&&c.current&&i(),S||(l.current=!0)},[S,i]),F.createElement(ll,{ref:r,disabled:S,label:e?"Zoom in":"Zoom out",icon:e?Mw:Ew,renderIcon:e?v.iconZoomIn:v.iconZoomOut,onClick:e?p:g,onFocus:()=>{c.current=!0},onBlur:()=>{c.current=!1}})});function yw(){const s=F.useRef(null),e=F.useRef(null),{focus:i}=wa(),r=F.useCallback(f=>{var d,m;!((d=f.current)===null||d===void 0)&&d.disabled?i():(m=f.current)===null||m===void 0||m.focus()},[i]),l=F.useCallback(()=>r(s),[r]),c=F.useCallback(()=>r(e),[r]);return F.createElement(F.Fragment,null,F.createElement(Av,{zoomIn:!0,ref:s,onLoseFocus:c}),F.createElement(Av,{ref:e,onLoseFocus:l}))}function bw(){const{render:s}=Zn(),e=Op();return s.buttonZoom?F.createElement(F.Fragment,null,s.buttonZoom(e)):F.createElement(yw,null)}function Tw(s){var e;return(((e=s.srcSet)===null||e===void 0?void 0:e.length)||0)>0}function Aw({current:s,preload:e},{type:i,source:r}){switch(i){case"fetch":return s?{current:s,preload:r}:{current:r};case"done":return r===e?{current:r}:{current:s,preload:e};default:throw new Error(Gv)}}function Rw(s){var e,i;const[{current:r,preload:l},c]=F.useReducer(Aw,{}),{slide:f,rect:d,imageFit:m,render:p,interactive:g}=s,_=f.srcSet.sort((L,z)=>L.width-z.width),v=(e=f.width)!==null&&e!==void 0?e:_[_.length-1].width,S=(i=f.height)!==null&&i!==void 0?i:_[_.length-1].height,y=_p(f,m),T=Math.max(..._.map(L=>L.width)),M=Math.min((y?Math.max:Math.min)(d.width,v*(d.height/S)),T),x=kE(),O=Lt(()=>{var L;const z=(L=_.find(N=>N.width>=M*x))!==null&&L!==void 0?L:_[_.length-1];(!r||_.findIndex(N=>N.src===r)<_.findIndex(N=>N===z))&&c({type:"fetch",source:z.src})});wi(O,[d.width,d.height,x,O]);const C=Lt(L=>c({type:"done",source:L})),P={WebkitTransform:g?"initial":"translateZ(0)"};return y||Object.assign(P,d.width/d.height<v/S?{width:"100%",height:"auto"}:{width:"auto",height:"100%"}),F.createElement(F.Fragment,null,l&&l!==r&&F.createElement(nu,{key:"preload",...s,offset:void 0,slide:{...f,src:l,srcSet:void 0},style:{position:"absolute",visibility:"hidden",...P},onLoad:()=>C(l),render:{...p,iconLoading:()=>null,iconError:()=>null}}),r&&F.createElement(nu,{key:"current",...s,slide:{...f,src:r,srcSet:void 0},style:P}))}function Cw({render:s,slide:e,offset:i,rect:r}){var l;const[c,f]=F.useState(),d=F.useRef(null),{zoom:m,maxZoom:p,offsetX:g,offsetY:_,setZoomWrapper:v}=Op(),S=m>1,{carousel:y,on:T}=Zn(),{currentIndex:M}=Ca();wi(()=>i===0?(v({zoomWrapperRef:d,imageDimensions:c}),()=>v(void 0)):()=>{},[i,c,v]);let x=(l=s.slide)===null||l===void 0?void 0:l.call(s,{slide:e,offset:i,rect:r,zoom:m,maxZoom:p});if(!x&&Xr(e)){const O={slide:e,offset:i,rect:r,render:s,imageFit:y.imageFit,imageProps:y.imageProps,onClick:i===0?()=>{var C;return(C=T.click)===null||C===void 0?void 0:C.call(T,{index:M})}:void 0};x=Tw(e)?F.createElement(Rw,{...O,slide:e,interactive:S,rect:i===0?{width:r.width*m,height:r.height*m}:r}):F.createElement(nu,{onLoad:C=>f({width:C.naturalWidth,height:C.naturalHeight}),...O})}return x?F.createElement("div",{ref:d,className:Ci(xt(Nv),xt(up),xt(Pv),S&&xt(OE)),style:i===0?{transform:`scale(${m}) translateX(${g}px) translateY(${_}px)`}:void 0},x):null}const ww=({augment:s,addModule:e})=>{s(({zoom:i,toolbar:r,render:l,controller:c,...f})=>{const d=kx(i);return{zoom:d,toolbar:xp(r,g_,F.createElement(bw,null)),render:{...l,slide:m=>{var p;return Xr(m.slide)?F.createElement(Cw,{render:l,...m}):(p=l.slide)===null||p===void 0?void 0:p.call(l,m)}},controller:{...c,preventDefaultWheelY:d.scrollToZoom},...f}}),e(Ra(g_,Sw))};function Dw(){const[s,e]=F.useState(-1),i=[{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/1.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/2.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/3.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/4.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/5.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/6.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/7.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/8.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/9.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/10.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/11.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/12.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/1.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/2.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/3.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/4.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/5.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/6.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/7.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/8.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/9.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/10.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/11.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/12.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/1.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/2.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/3.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/4.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/5.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/6.jpeg?raw=true",width:1280,height:853},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/7.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/8.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/9.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/10.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/11.jpeg?raw=true",width:853,height:1280},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/12.jpeg?raw=true",width:1280,height:853}];return Zt.jsxs(Zt.Fragment,{children:[Zt.jsx(ew,{rotation:0,speed:.2,scale:.9,frequency:1,warpStrength:1,mouseInfluence:1,parallax:0,transparent:!1}),Zt.jsx("div",{className:"nav-bar",children:Zt.jsxs("ul",{children:[Zt.jsx("li",{children:"Home"}),Zt.jsx("li",{children:"Contact"}),Zt.jsx("li",{children:"About"})]})}),Zt.jsxs("div",{className:"title-bar",children:[Zt.jsx("h1",{children:"Tyler Brodnicki"}),Zt.jsx("h2",{children:"Photographer"}),Zt.jsx("h3",{children:"Gallery"})]}),Zt.jsxs("div",{className:"content",children:[Zt.jsx(RE,{photos:i,spacing:15,rowConstraints:{singleRowMaxHeight:350},onClick:({index:r})=>e(r)}),Zt.jsx(By,{slides:[{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/1.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/2.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/3.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/4.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/5.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/6.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/7.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/8.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/9.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/10.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/11.jpeg?raw=true"},{src:"https://github.com/tbrodnicki-dev/website/blob/main/public/12.jpeg?raw=true"}],open:s>=0,index:s,close:()=>e(-1),plugins:[ow,ww,dw]})]}),Zt.jsx("div",{className:"footer",children:Zt.jsx("p",{children:"© 2026 Tyler Brodnicki. All rights reserved."})})]})}eE.createRoot(document.getElementById("root")).render(Zt.jsx(F.StrictMode,{children:Zt.jsx(Dw,{})}));
